...
import com.appazal.quizzle.model.Topic;
...
public class TestPuzzle {
	...
	public static void main(String[] arguments) throws Exception {
		...
		topics[0] = new Topic(11, "Java-Swing");
		p[0].setTopics(topics);
		...
		String puzzleJson3 = "[{'topics':[{'id':11,'name':'Java-Swinger'}],'question':{'imagePath':'/res/foo.png','id':1,'type':'ImageQuestion'},'options':[{'text':'Gazal','questionId':1,'isCorrect':true,'type':'TextOption'},{'text':'Maria','questionId':1,'isCorrect':false,'type':'TextOption'},{'text':'Pooja','questionId':1,'isCorrect':false,'type':'TextOption'},{'text':'Pradeep','questionId':1,'isCorrect':false,'type':'TextOption'}]},{'question':{'text':'What is your name','id':22,'type':'TextQuestion'},'options':[{'text':'Gazal','questionId':1,'isCorrect':true,'type':'TextOption'},{'text':'Maria','questionId':1,'isCorrect':false,'type':'TextOption'},{'text':'Pooja','questionId':1,'isCorrect':false,'type':'TextOption'},{'text':'Pradeep','questionId':1,'isCorrect':false,'type':'TextOption'}]}]";

		Puzzle[] pJsons = PuzzleService.convertJsonToPuzzle(puzzleJson3);
		System.out.println(pJsons[1].getQuestion().getId());
		System.out.println(pJsons[0].getTopics()[0].getName());
